...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        // A warm near-black scrim at real opacity, not a diluted pure-black one --
        // #15120f/70 actually separates the drawer from the page underneath it.
        "fixed inset-0 z-50 bg-background/70 duration-100 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className
      )}
      {...props}
    />
